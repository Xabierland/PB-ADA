...
begin
   ...
   Put("Primera prueba: Primo_y_capicua_mayor(2) debe ser 2 y el resultado es ");
   Put(primo_y_capicua_mayor(2));
   New_Line(3);
   Put_Line("Pulsa return para continuar");
   Skip_Line;

   Put("Primera prueba: Primo_y_capicua_mayor(3) debe ser 3 y el resultado es ");
   Put(primo_y_capicua_mayor(3));
   New_Line(3);
   Put_Line("Pulsa return para continuar");
   Skip_Line;
   ...
   Put("Segunda prueba: Primo_y_capicua_mayor(500) debe ser 101 y el resultado es ");
   Put(primo_y_capicua_mayor(500));
   New_Line(3);
   Put_Line("Pulsa return para continuar");
   Skip_Line;
