...
begin
   ...
   n2:=3;
   n3:=1;
   put_line("el orden debería ser 5 3 1");
   ...
   n2:=5;
   n3:=5;
   put_line("el orden debería ser 5 5 5");
   put_line("Y tu programa dice:     ");
   ordenar_tres_numeros(n1,n2,n3);
   put(n1);
   put(n2);
   ...
   n2:=0;
   n3:=0;
   put_line("el orden debería ser 0 0 0");
   put_line("Y tu programa dice:     ");
   ordenar_tres_numeros(n1,n2,n3);
   put(n1);
   put(n2);
   ...
   n2:=20;
   n3:=30;
   put_line("el orden debería ser 30 20 10");
   put_line("Y tu programa dice:     ");
   ordenar_tres_numeros(n1,n2,n3);
   put(n1);
   put(n2);
   ...
   n2:=0;
   n3:=10;
   put_line("el orden debería ser 10 5 0");
   put_line("Y tu programa dice:     ");
   ordenar_tres_numeros(n1,n2,n3);
   put(n1);
   put(n2);
