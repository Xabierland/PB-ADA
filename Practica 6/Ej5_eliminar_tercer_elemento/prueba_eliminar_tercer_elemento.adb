...
begin
   ...
   new_line;
   put_line(" el resultado debería de ser 1 2 4  <--> SIN IMPORTAR EL ORDEN DE LOS ELEMENTOS");
   ...
   escribir_lista(Lista1);
   new_line;
   put_line(" el resultado debería de ser 1 2 5 4  <--> SIN IMPORTAR EL ORDEN DE LOS ELEMENTOS");
   put_line("y la lista resultado es: ");
   eliminar_tercer_elemento(Lista1);
   escribir_lista(Lista1);
   new_line(3);
